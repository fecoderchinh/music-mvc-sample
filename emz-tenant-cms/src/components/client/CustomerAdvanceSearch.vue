<template>
  ...
  <div class="p-0 search-box-content">
    <div class="search-box-content-widget" :class="tbData.Items.length > 5 ? 'widget-overflow' : ''">

      <div class="-mx-5 hover:bg-gray-200 py-2" v-for="(data, index) in tbData.Items" :key="index">
        <div class="px-5 flex">
    ...
    return {
      ...
      tbData: {
        Items: [
          {
            thumb: 'thumbnail',
            DataTitle: 'Nguyễn Văn Tên 1',
            DataValue: ['0123 456 789'],
          },
          {
            thumb: 'thumbnail',
            DataTitle: 'Nguyễn Văn Tên 2',
            DataValue: ['0123 456 789'],
          },
          {
            thumb: 'thumbnail',
            DataTitle: 'Nguyễn Văn Tên 3',
            DataValue: ['0123 456 789'],
          },
        ],
      },
