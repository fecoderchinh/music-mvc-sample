        ...
        <div class="col-span-4 sm:col-span-6 xl:pt-10">
          <VueSlickCarousel ref="image" v-bind="settings1" @beforeChange="onBeforeChangeC1">
            <div class="relative select-none" v-for="(data, index) in slideData" :key="index">
              <div class="desktop" :style="{ 'background-image':  `url(${require('~/assets/images/desktop.svg')})` } ">
                <div class="desktop-inner">
                  <img :src="data.desktopImg" :alt="data.name" class="w-full" draggable="false">
                </div>
              </div>
              <div class="mobile sm:hidden bg-no-repeat bg-cover md:right-0 md:bottom-0" 
                :style="{'background-image': `url(${require('~/assets/images/mobile.svg')})` }">
            ...
            <div class="cms-typo sm:mt-5" v-for="(data, index) in slideData" :key="index">
              ...
              <div class="mt-30px">
                <div class="inline">
                  ...
                  <NuxtLink :to="{ name: 'theme-slug',  params: { slug: data.hrefDetail } }"
                    class="cms-button cms-button-rounded outline cms-button-green cms-button-lg">
                    Chi tiết
                  </NuxtLink>
