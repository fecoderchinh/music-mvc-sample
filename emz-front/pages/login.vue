	...
	<div class="container">
		<header>
			...
			<div class="px-5 hidden">
				<h3 class="cms-typo text-white text-base"><NuxtLink to="/register">Đăng ký</NuxtLink></h3>
			</div>
		</header>
	</div>
	<div class="container">
						...
						<div class="bg-white p-30px rounded-lg">
                            ...
                            <form @submit.prevent="handleSubmit(submitForm)" action="/login" method="post" autocomplete="off">
                                ...
                                <div class="cms-input relative flex-auto mt-30px cms__label-inside">
                                    <input tabindex="1" v-model="form.phone" autocomplete="off" type="tel" id="login-input-sdt" name="phone" class="typed bg-white cms-typo focus:outline-none border rounded w-full pl-5">
                                ...
                                <div class="cms-input relative flex-auto mt-30px cms__label-inside">
                                    <input tabindex="2" v-model="form.password" autocomplete="off" type="password" id="login-input-mk" name="password" class="typed bg-white cms-typo focus:outline-none border rounded w-full pl-5">
                                ...
                                <p class="text-lg cms-typo text-placeholderStyle mt-30px">Bạn quên mật khẩu? 
                                <NuxtLink class="text-buttonAndURL ml-15px" to="/forgot">Lấy lại mật khẩu</NuxtLink>
